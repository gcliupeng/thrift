...
$so=new TServerSocket();
$ser=new TSimpleServer($processor,$so,new TTransportFactory(),new TTransportFactory(),new TBinaryProtocolFactory(),new TBinaryProtocolFactory());
$ser->serve();
